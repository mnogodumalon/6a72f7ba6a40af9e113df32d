...
// <custom:intent-imports>
import { IconClipboardPlus, IconFileInvoice, IconCalendarCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: { de: 'Auftrag anlegen', en: 'Create order' }, icon: IconClipboardPlus, description: 'Neuen Werkstattauftrag in 3 Schritten anlegen' },
  { path: '/intents/auftrag-abschliessen', label: { de: 'Auftrag abschließen', en: 'Close order' }, icon: IconFileInvoice, description: 'Auftrag abschließen und Rechnung erstellen' },
