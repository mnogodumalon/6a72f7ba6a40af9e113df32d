...
// <custom:intent-imports>
import { IconClipboardPlus, IconCircleCheck, IconCalendarCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neuer-auftrag', label: { de: 'Neuer Auftrag', en: 'New Order' }, icon: IconClipboardPlus, description: 'Neuen Werkstattauftrag anlegen' },
  { path: '/intents/auftrag-abschliessen', label: { de: 'Auftrag abschließen', en: 'Close Order' }, icon: IconCircleCheck, description: 'Auftrag abschließen und Rechnung erstellen' },
