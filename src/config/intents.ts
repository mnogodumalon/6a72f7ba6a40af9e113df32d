...
// <custom:intent-imports>
import { IconClipboardPlus, IconCheckbox } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neuer-auftrag', label: 'Neuer Auftrag', icon: IconClipboardPlus, description: 'Werkstattauftrag in 3 Schritten anlegen' },
  { path: '/intents/auftrag-abschliessen', label: 'Auftrag abschließen', icon: IconCheckbox, description: 'Auftrag abschließen und Rechnung erstellen' },
  // </custom:intents>
];
