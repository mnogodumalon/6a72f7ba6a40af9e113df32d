...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/auftrag-abrechnung', label: { de: 'Auftrag abrechnen', en: 'Invoice order' }, icon: IconFileInvoice, description: 'Auftrag abschließen und Rechnung erstellen' },
  // </custom:intents>
];
