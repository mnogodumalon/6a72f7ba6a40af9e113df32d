...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: { de: 'Auftrag anlegen', en: 'Create order' }, icon: IconClipboardPlus, description: 'Neuen Auftrag in 3 Schritten anlegen' },
  { path: '/intents/auftrag-abrechnung', label: { de: 'Auftrag abrechnen', en: 'Bill order' }, icon: IconReceipt, description: 'Abgeschlossenen Auftrag in Rechnung stellen und PDF anlegen' },
  // </custom:intents>
];
