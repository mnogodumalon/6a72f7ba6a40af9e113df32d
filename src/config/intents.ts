...
// <custom:intent-imports>
import { IconClipboardPlus, IconReceiptDollar } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neuer-auftrag', label: { de: 'Neuer Auftrag', en: 'New Order' }, icon: IconClipboardPlus, description: 'Kunden, Fahrzeug und Auftrag in einem Ablauf anlegen' },
  { path: '/intents/auftrag-abschliessen', label: { de: 'Auftrag abschließen', en: 'Close Order' }, icon: IconReceiptDollar, description: 'Auftrag abschließen und Rechnung erstellen' },
  // </custom:intents>
];
