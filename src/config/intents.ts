...
// <custom:intent-imports>
import { IconClipboardPlus, IconFileInvoice } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neuen-auftrag-anlegen', label: { de: 'Auftrag anlegen', en: 'New order' }, icon: IconClipboardPlus, description: 'Kunden und Fahrzeug wählen, Auftrag erfassen' },
  { path: '/intents/auftrag-abrechnen', label: { de: 'Auftrag abrechnen', en: 'Invoice order' }, icon: IconFileInvoice, description: 'Abgeschlossenen Auftrag abrechnen und Rechnung erstellen' },
  // </custom:intents>
];
