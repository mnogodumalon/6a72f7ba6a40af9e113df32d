...
// <custom:intent-imports>
import { IconClipboardPlus, IconReceipt } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neuen-auftrag-erstellen', label: { de: 'Neuer Auftrag', en: 'New Order' }, icon: IconClipboardPlus, description: 'Neuen Werkstattauftrag in 3 Schritten anlegen' },
  { path: '/intents/auftrag-abschliessen', label: { de: 'Auftrag abschließen', en: 'Close Order' }, icon: IconReceipt, description: 'Auftrag abschließen, Rechnung und PDF erstellen' },
  // </custom:intents>
];
