...
// <custom:intent-imports>
import { IconClipboardPlus, IconCheckbox, IconCalendarCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neuer-auftrag', label: { de: 'Neuer Auftrag', en: 'New Order' }, icon: IconClipboardPlus, description: 'Werkstattauftrag in drei Schritten anlegen' },
  { path: '/intents/auftrag-abschliessen', label: { de: 'Auftrag abschließen', en: 'Close Order' }, icon: IconCheckbox, description: 'Auftrag abschließen, Rechnung erstellen und PDF anlegen' },
