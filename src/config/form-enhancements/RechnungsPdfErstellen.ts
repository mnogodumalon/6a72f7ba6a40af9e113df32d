// Auto-generated. Per-entity form-enhancements config for "Rechnungs-PDF erstellen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["rechnung", "pdf_rechnungsnummer", {"row": ["pdf_kunde_vorname", "pdf_kunde_nachname"]}, "pdf_nettobetrag", "pdf_bruttobetrag", "pdf_datei"],
  defaults: {},
  computed: {},
};
