// Auto-generated. Per-entity form-enhancements config for "Jahresinspektion planen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["fahrzeug", "wunschtermin_inspektion", "arbeitsbeschreibung_inspektion", "bemerkungen_inspektion"],
  defaults: {
