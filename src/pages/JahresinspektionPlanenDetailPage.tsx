...
export default function JahresinspektionPlanenDetailPage() {
  ...
  return (
    ...
    >
      <RecordHeader title={appLabel('jahresinspektion_planen')} />
      ...
      <RecordSection title={t('details')} cols={2}>
        <RecordField label={fieldLabel('jahresinspektion_planen', 'fahrzeug')} value={getFahrzeugeDisplayName(record.fields.fahrzeug)} format="text" />
      ...
      <ConfirmDialog
        ...
        title={t('delete_entity', { entity: appLabel('jahresinspektion_planen') })}
