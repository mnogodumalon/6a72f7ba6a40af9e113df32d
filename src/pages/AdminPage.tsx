...
const ENTITY_TABS = [
  ...
  { key: 'jahresinspektion_planen', label: 'Jahresinspektion planen', pascal: 'JahresinspektionPlanen' },
  { key: 'rechnungs_pdf_erstellen', label: 'Rechnungs-PDF erstellen', pascal: 'RechnungsPdfErstellen' },
] as const;
...
export default function AdminPage() {
  ...
  const getFieldMeta = useCallback((entity: EntityKey) => {
    switch (entity) {
      ...
      case 'jahresinspektion_planen': return JAHRESINSPEKTIONPLANEN_FIELDS;
      case 'rechnungs_pdf_erstellen': return RECHNUNGSPDFERSTELLEN_FIELDS;
      default: return [];
    }
  }, []);
