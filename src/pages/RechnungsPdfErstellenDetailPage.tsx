...
export default function RechnungsPdfErstellenDetailPage() {
  ...
  return (
    ...
    >
      <RecordHeader title={record.fields.pdf_rechnungsnummer ?? 'Rechnungs-PDF erstellen'} />
      ...
      <RecordSection title="Details" cols={2}>
        <RecordField label="Rechnung" value={getRechnungenDisplayName(record.fields.rechnung)} format="text" />
