  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'nettobetrag': (
      <div key="nettobetrag" className="space-y-1.5">
        <Label htmlFor="nettobetrag">Nettobetrag (€) <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="nettobetrag"
          type="number"
          step="any"
    ...
    'mwst_satz': (
      <div key="mwst_satz" className="space-y-1.5">
        <Label htmlFor="mwst_satz">MwSt.-Satz <span className="text-destructive" aria-hidden="true">*</span></Label>
    ...
    'bruttobetrag': (
      <div key="bruttobetrag" className="space-y-1.5">
        <Label htmlFor="bruttobetrag">Bruttobetrag (€) <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="bruttobetrag"
          type="number"
          step="any"
    ...
    'status_rechnung': (
      <div key="status_rechnung" className="space-y-1.5">
        <Label htmlFor="status_rechnung">Status <span className="text-destructive" aria-hidden="true">*</span></Label>
        <div role="radiogroup" className="flex flex-wrap gap-1.5">
          <button
            type="button"
            role="radio"
    ...
    'pdf_anhang': (
      <div key="pdf_anhang" className="space-y-1.5">
        <Label htmlFor="pdf_anhang">PDF-Anhang</Label>
        {fields.pdf_anhang ? (
