...
export function KundenDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: KundenDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'bemerkungen_kunde': (
      <div key="bemerkungen_kunde" className="space-y-1.5">
        <Label htmlFor="bemerkungen_kunde">{fieldLabel('kunden', 'bemerkungen_kunde')}</Label>
        <Textarea
          id="bemerkungen_kunde"
          placeholder="Besonderheiten, bevorzugte Kontaktzeit, Zahlungsbedingungen..."
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "email": "E-Mail-Adresse", "telefon": "Telefonnummer", "strasse": "Straße", "hausnummer": "Hausnummer", "plz": "Postleitzahl", "ort": "Ort", "bemerkungen_kunde": "Bemerkungen"};
