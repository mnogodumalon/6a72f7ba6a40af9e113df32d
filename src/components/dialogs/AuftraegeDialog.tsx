  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'arbeitsbeschreibung': (
      <div key="arbeitsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was muss repariert werden? Symptome, Fehlercodes..."
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Wann soll die Reparatur stattfinden?"
          mode="datetime"
    ...
    'bemerkungen_auftrag': (
      <div key="bemerkungen_auftrag" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Besondere Anweisungen, Ersatzteile, Testfahrt..."
