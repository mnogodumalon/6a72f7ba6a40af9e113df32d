  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'arbeitsbeschreibung': (
      <div key="arbeitsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Welche Arbeiten sind nötig? Schäden, Inspektionspunkte, Wartung..."
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Wann soll die Arbeit stattfinden?"
          mode="datetime"
    ...
    'bemerkungen_auftrag': (
      <div key="bemerkungen_auftrag" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zusätzliche Infos, Teile-Bestellung, Besonderheiten..."
