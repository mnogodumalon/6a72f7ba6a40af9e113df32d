  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'arbeitsbeschreibung': (
      <div key="arbeitsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was ist zu tun? Mängel, Reparaturen, Austausche, Überprüfungen..."
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Wann sollte es fertig sein?"
          mode="datetime"
    ...
    'bemerkungen_auftrag': (
      <div key="bemerkungen_auftrag" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Spezielle Anweisungen, Material, Hinweise..."
