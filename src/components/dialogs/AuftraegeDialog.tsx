  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'arbeitsbeschreibung': (
      <div key="arbeitsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was soll repariert oder gewartet werden? Detaillierte Beschreibung der Arbeiten."
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Wann soll die Arbeit erledigt sein?"
          mode="datetime"
    ...
    'bemerkungen_auftrag': (
      <div key="bemerkungen_auftrag" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Weitere Hinweise, besondere Wünsche des Kunden..."
